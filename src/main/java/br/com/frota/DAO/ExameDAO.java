...
public class ExameDAO extends ConexaoDB{
    ...
    public Exame insert(Exame entidade) {
        try (PreparedStatement preparedStatement = prepararSQL(INSERT_EXAME_SQL, java.sql.Statement.RETURN_GENERATED_KEYS)) {
    ...
    public Exame findById(Integer id) {
        ...
        try (PreparedStatement preparedStatement = prepararSQL(SELECT_EXAME_BY_ID)) {
            ...
            while (rs.next()) {
                ...
                Integer materialExameId = rs.getInt("material_exame_id");
